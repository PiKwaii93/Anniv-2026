  ...
  return <>
    ...
    <main className="guest-page guest-home" inert={!isAdmin && (identityLoading || !identity)}>
      ...
      <section className="guest-section"><h2>Organisation de la soirée</h2><div className="guest-activity-list">
        <Link to="/info" className="guest-activity event-info-home-link"><span className="guest-activity__icon" aria-hidden="true">i</span><div><h3>Infos pratiques</h3><p>Date, lieu, accès et détails utiles pour la soirée.</p></div><span aria-hidden="true">→</span></Link>
